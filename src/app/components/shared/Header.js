    ...
    <div className=" sticky top-0 bg-black z-50 py-4 w-[calc(100%_-_12px)] xl:w-[1200px] mx-auto ">
      <div className="flex items-center justify-between">
        ...
        <div className="md:hidden relative z-50">
            ...
            <div className={`flex flex-col gap-10 absolute !z-50 top-10 p-3 overflow-hidden rounded w-[200px] right-0 ${open?'-translate-x-2 duration-300 delay-100':'translate-x-2 opacity-0 invisible  absolute duration-300 delay-100'} bg-slate-800/65 backdrop-opacity-20 backdrop-invert  shadow-xl`}>
