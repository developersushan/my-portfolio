    ...
    <div className="    py-2 w-[calc(100%_-_12px)] xl:w-[1200px] mx-auto ">
      <div className="flex items-center justify-between">
        ...
        <div className="md:hidden relative ">
            ...
            <div className={`flex flex-col gap-10 absolute top-10 p-3 overflow-hidden rounded w-[200px] right-0 ${open?'-translate-x-2 duration-300 delay-100':'translate-x-2 opacity-0 invisible  absolute duration-300 delay-100'} bg-slate-800 shadow-xl`}>
